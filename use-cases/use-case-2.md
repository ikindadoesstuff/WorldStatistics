# USE CASE 2: View Top N Countries in the World/Continent/Region

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I want to view the top N most populated countries in different geographical limits so that I can 
...
A report of the top N most populated countries in the World/Continent/Region is available to the data analyst.
...
Data analyst requests report of top N most populated countries in specified geographical limit.
